 ...
 * }
 */
function OPMSlide(opt){
    return (this instanceof OPMSlide)?this.init(opt):new OPMSlide(opt);
}
OPMSlide.prototype.init=function(opt){
...
OPMSlide.prototype._doPlay=function(){
    var self=this;
...
OPMSlide.prototype._start=function(e){
    var self=this;
...
OPMSlide.prototype._move=function(e){
    var self=this;
    if(!self.scrolling)return;
...
OPMSlide.prototype._end=function(e){
    e.stopPropagation();
    var self=this;
    var ops=self.options;
    self.stop=false;
...
OPMSlide.prototype._click=function(e){
    e.preventDefault();
    e.stopPropagation();
};
OPMSlide.prototype._getPage=function(e){
    return e.changedTouches?e.changedTouches[0]:e;
};
OPMSlide.prototype._translate=function(dist,speed){
...
OPMSlide.prototype._autoRun=function(s){
    var self=s;
    var fn=function(scope){
        return setTimeout(function(){
...
OPMSlide.prototype.handleEvent=function(event){
    var self = this;
...
OPMSlide.prototype.toNext=function(){
    var self=this;
    self.index++;
    self._doPlay();
};
OPMSlide.prototype.toPre=function(){
    var self=this;
    self.index--;
    self._doPlay();
};
